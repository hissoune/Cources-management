<x-app-layout>
    ...
    <x-slot name="slot">
        ...
        <div class="relative overflow-x-auto my-6">
            ...
            <button data-modal-target="#crud-modal" class="block text-white bg-green-700 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-800 my-5" type="button">
                add fillier
            </button>
