...
<div class="max-w-md mx-auto bg-white p-8 rounded-md shadow-md">
    ...
    <form method="POST" action="{{ route('Abonnment_store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-4">
            ...
            <select  id="type" name="type" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                ...
                <option value="premiume">premiume</option>
        ...
        <div class="mb-4">
            ...
            <input type="number" id="number_cources" name="number_cources" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="number_days" name="number_days" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            @error('number_days')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
        @enderror
        </div>
